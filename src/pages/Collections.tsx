        ...
        <section className="section-padding bg-cream">
          <div className="container-luxury">
            <motion.div className="text-center mb-12" initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }}>
              <h1 className="text-5xl md:text-6xl font-display font-light mb-4">All Collections</h1>
              <p className="text-muted-foreground max-w-lg mx-auto">Explore our complete range</p>
            </motion.div>
